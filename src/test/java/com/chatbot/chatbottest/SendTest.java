...
public class SendTest {
    ...
    private final MessengerHttpClient.HttpResponse fakeResponse = new MessengerHttpClient.HttpResponse(200, "{\n" +
    ...
    public void beforeEach() throws Exception {
        when(mockHttpClient.execute(any(MessengerHttpClient.HttpMethod.class), anyString(), anyString())).thenReturn(fakeResponse);
    }
    ...
    public void shouldSendSenderAction() throws Exception {
        ...
        verify(mockHttpClient).execute(eq(POST), String.valueOf(endsWith(PAGE_ACCESS_TOKEN)), payloadCaptor.capture());
